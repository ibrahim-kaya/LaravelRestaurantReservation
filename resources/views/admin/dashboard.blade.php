...
@section('title') Anaysayfa @endsection
...
@section('content')
        ...
        <div class="flex flex-wrap">
            <div class="w-full xl:w-8/12 mb-12 xl:mb-0 px-4">
                <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-700">
        ...
        @livewire('admin.dashboard-today-reservations')

        @livewire('admin.dashboard-reservations')
                    ...
                    <div class="rounded-lg mb-0 px-4 py-3 border-0">
                        <div class="flex flex-wrap items-center">
                            ...
                            <div class="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                                <button class="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                        type="button">
                                    See all
                                </button>
                            </div>
                                ...
                                >
                                    <div class="flex items-center">
                                        ...
                                        <div class="relative w-full">
                                            <div
                                                class="overflow-hidden h-2 text-xs flex rounded-lg bg-red-200"
                                            >
                                                <div
                                                    style="width: 60%"
                            ...
                            <tr>
                                ...
                                >
                                    <div class="flex items-center">
                                        ...
                                        <div class="relative w-full">
                                            <div
                                                class="overflow-hidden h-2 text-xs flex rounded-lg bg-emerald-200"
                                            >
                                                <div
                                                    style="width: 70%"
                            ...
                            <tr>
                                ...
                                >
                                    <div class="flex items-center">
                                        ...
                                        <div class="relative w-full">
                                            <div
                                                class="overflow-hidden h-2 text-xs flex rounded-lg bg-purple-200"
                                            >
                                                <div
                                                    style="width: 80%"
                            ...
                            <tr>
                                ...
                                >
                                    <div class="flex items-center">
                                        ...
                                        <div class="relative w-full">
                                            <div
                                                class="overflow-hidden h-2 text-xs flex rounded-lg bg-lightBlue-200"
                                            >
                                                <div
                                                    style="width: 75%"
                            ...
                            <tr>
                                ...
                                >
                                    <div class="flex items-center">
                                        ...
                                        <div class="relative w-full">
                                            <div
                                                class="overflow-hidden h-2 text-xs flex rounded-lg bg-orange-200"
                                            >
                                                <div
                                                    style="width: 30%"
                                                    class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-emerald-500"
